...
import { BookOpen, Zap, Trophy, Clock, PlayCircle, Lock } from "lucide-react";
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <Card className="bg-[hsl(48,96%,75%)] border-none hover:scale-[1.02] transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription className="text-foreground/70">Foundation concepts with Playwright & Cypress examples</CardDescription>
              </CardHeader>
            </Card>
            <Card className="bg-[hsl(145,70%,65%)] border-none hover:scale-[1.02] transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription className="text-foreground/70">Advanced patterns and design principles</CardDescription>
              </CardHeader>
            </Card>
            <Card className="bg-[hsl(195,90%,65%)] border-none hover:scale-[1.02] transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription className="text-foreground/70">Expert-level architecture and optimization</CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="space-y-12">
            {allCourses.map((course, courseIndex) => {
              ...
              for (let i = 0; i < courseIndex; i++) {
                allCourses[i].sections.forEach(section => {
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                          {section.lessons.map((lesson) => {
                            ...
                            return (
                              <Link
                                key={lesson.id}
                                to={hasAccess ? `/typescript-lesson/${lesson.id}` : '#'}
                                onClick={handleClick}
