...
import { ArrowLeft, ArrowRight, CheckCircle, AlertTriangle, BookOpen, Lightbulb, Target, ExternalLink } from "lucide-react";
import { allTestManagementCourses } from "@/data/testManagementLessons";
import { generateTestManagementContent } from "@/utils/generateTestManagementContent";

const TestManagementLesson = () => {
  ...
  for (const course of allTestManagementCourses) {
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-24 pb-16 max-w-4xl mx-auto px-6">
          ...
          <Link to="/test-management" className="text-primary hover:underline">
            Back to Test Management Course
          </Link>
        </main>
        <Footer />
      </div>
  ...
  const content = generateTestManagementContent(lessonId!, currentLesson.title);
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          {/* Breadcrumb */}
          <div className="mb-6">
            <Link to="/test-management" className="text-primary hover:underline text-sm flex items-center gap-1">
          ...
          <div className="flex justify-between items-center pt-6 border-t border-border">
            {prevLesson ? (
              <Link to={`/test-management-lesson/${prevLesson.id}`}>
            ...
            {nextLesson ? (
              <Link to={`/test-management-lesson/${nextLesson.id}`}>
...
export default TestManagementLesson;
