  ...
  sections: [
    {
      ...
      lessons: [
        { id: 'ts-basic-001', title: 'Variables: let, const, and var Explained', duration: '15 min', level: 'basic' },
        { id: 'ts-basic-002', title: 'Constants and Immutability in TypeScript', duration: '12 min', level: 'basic' },
        { id: 'ts-basic-003', title: 'Type Annotations and Type Inference', duration: '14 min', level: 'basic' },
        { id: 'ts-basic-004', title: 'Primitive Types: string, number, boolean', duration: '10 min', level: 'basic' },
        { id: 'ts-basic-005', title: 'Arrays and Tuples', duration: '15 min', level: 'basic' },
        { id: 'ts-basic-006', title: 'Objects and Type Aliases', duration: '18 min', level: 'basic' },
        { id: 'ts-basic-007', title: 'Union and Intersection Types', duration: '20 min', level: 'basic' },
        { id: 'ts-basic-008', title: 'Literal Types and Type Narrowing', duration: '14 min', level: 'basic' },
        { id: 'ts-basic-009', title: 'Functions and Function Types', duration: '16 min', level: 'basic' },
        { id: 'ts-basic-010', title: 'Optional and Default Parameters', duration: '12 min', level: 'basic' },
        { id: 'ts-basic-011', title: 'Rest Parameters and Spread Operator', duration: '15 min', level: 'basic' },
        { id: 'ts-basic-012', title: 'Void, Never, and Unknown Types', duration: '13 min', level: 'basic' },
        { id: 'ts-basic-013', title: 'Type Assertions and Type Casting', duration: '14 min', level: 'basic' },
        { id: 'ts-basic-014', title: 'Enums: Numeric and String', duration: '17 min', level: 'basic' },
        { id: 'ts-basic-015', title: 'Any vs Unknown: When to Use', duration: '11 min', level: 'basic' },
        { id: 'ts-basic-016', title: 'Null and Undefined Handling', duration: '13 min', level: 'basic' },
        { id: 'ts-basic-017', title: 'Type Inference Best Practices', duration: '15 min', level: 'basic' },
      ]
    },
    {
      ...
      lessons: [
        { id: 'ts-basic-018', title: 'Defining Interfaces', duration: '14 min', level: 'basic' },
        { id: 'ts-basic-019', title: 'Optional Properties in Interfaces', duration: '10 min', level: 'basic' },
        { id: 'ts-basic-020', title: 'Readonly Properties', duration: '12 min', level: 'basic' },
        { id: 'ts-basic-021', title: 'Extending Interfaces', duration: '16 min', level: 'basic' },
        { id: 'ts-basic-022', title: 'Index Signatures', duration: '14 min', level: 'basic' },
        { id: 'ts-basic-023', title: 'Class Basics and Constructors', duration: '18 min', level: 'basic' },
        { id: 'ts-basic-024', title: 'Access Modifiers: public, private, protected', duration: '15 min', level: 'basic' },
        { id: 'ts-basic-025', title: 'Getters and Setters', duration: '13 min', level: 'basic' },
        { id: 'ts-basic-026', title: 'Static Members', duration: '12 min', level: 'basic' },
        { id: 'ts-basic-027', title: 'Abstract Classes', duration: '17 min', level: 'basic' },
        { id: 'ts-basic-028', title: 'Implementing Interfaces in Classes', duration: '14 min', level: 'basic' },
        { id: 'ts-basic-029', title: 'Class Inheritance', duration: '19 min', level: 'basic' },
        { id: 'ts-basic-030', title: 'Method Overriding', duration: '13 min', level: 'basic' },
      ]
    },
    {
      ...
      lessons: [
        { id: 'ts-basic-031', title: 'Setting Up Playwright with TypeScript', duration: '16 min', level: 'basic' },
        { id: 'ts-basic-032', title: 'Type-Safe Page Object Model', duration: '22 min', level: 'basic' },
        { id: 'ts-basic-033', title: 'Typing Test Fixtures', duration: '18 min', level: 'basic' },
        { id: 'ts-basic-034', title: 'Custom Commands with Types', duration: '20 min', level: 'basic' },
        { id: 'ts-basic-035', title: 'Locator Types and Auto-Complete', duration: '15 min', level: 'basic' },
        { id: 'ts-basic-036', title: 'Response Types for API Testing', duration: '19 min', level: 'basic' },
        { id: 'ts-basic-037', title: 'Test Data Type Definitions', duration: '17 min', level: 'basic' },
        { id: 'ts-basic-038', title: 'Config File TypeScript Setup', duration: '14 min', level: 'basic' },
        { id: 'ts-basic-039', title: 'Custom Reporter Types', duration: '16 min', level: 'basic' },
        { id: 'ts-basic-040', title: 'Browser Context Types', duration: '13 min', level: 'basic' },
        { id: 'ts-basic-041', title: 'Screenshot and Video Types', duration: '12 min', level: 'basic' },
        { id: 'ts-basic-042', title: 'Network Interception Types', duration: '18 min', level: 'basic' },
      ]
    },
    {
      ...
      lessons: [
        { id: 'ts-basic-043', title: 'Setting Up Cypress with TypeScript', duration: '15 min', level: 'basic' },
        { id: 'ts-basic-044', title: 'Type-Safe Cypress Commands', duration: '20 min', level: 'basic' },
        { id: 'ts-basic-045', title: 'Custom Command Type Definitions', duration: '22 min', level: 'basic' },
        { id: 'ts-basic-046', title: 'Page Object Pattern in Cypress', duration: '24 min', level: 'basic' },
